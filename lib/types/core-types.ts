/**
 * 통합 타입 정의 파일
 * 기존의 분산된 타입 정의들을 통합하여 일관된 타입 시스템 제공
 */

// 기본 노드 타입 (모든 노드 타입의 기반)
...
export interface NodeExecutor {
  execute(node: NodeInstance, context: ExecutionContext): Promise<NodeExecutionResult>
}
